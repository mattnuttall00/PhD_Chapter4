...
scen5_summary_all <- rbind(Scen5_1_summary,Scen5_2_summary,Scen5_3_summary,
                           Scen5_4_summary,Scen5_5_summary,Scen5_6_summary,
                           Scen5_7_summary,Scen5_8_summary,Scen5_9_summary,
                           Scen5_10_summary)


write.csv(scen5_summary_all, file="CHANGE ME/scen5_summary.csv")