...
```{r ten_rep_0, eval=FALSE, cache=TRUE}
...
```
```{r ten_rep_0_plot, eval=FALSE, echo=FALSE}
...
```{r ten_rep_1_single, eval=TRUE, echo=TRUE, cache=TRUE}
...
```
```{r ten_rep_1_plot, echo=FALSE, eval=TRUE}
...
```{r ten_rep_3_single, echo=FALSE, eval=TRUE, cache=TRUE}
ten_rep_3 <- gmse(
  time_max = 40,
  land_dim_1 = 50,
  land_dim_2 = 50, # landscape is 2500ha or 25km2
...
```
```{r ten_rep_3_plot, echo=FALSE, eval=TRUE}
...
```{r ten_rep_4_plot_resources, echo=FALSE, eval=TRUE, warnings=FALSE}
...
```{r ten_rep_4_plot_actions, echo=FALSE, eval=TRUE, warning=FALSE}
...
```{r ten_rep_5, eval=FALSE, echo=TRUE}
...
```{r ten_rep_5_summary, echo=FALSE, eval=TRUE}
...
```{r ten_rep_6 & 7 cost plots, echo=FALSE}
...
```{r ten_rep_6 & 7 count plots, echo=FALSE}
...
```{r ten_rep_5, 6 & 7 lost plots, echo=FALSE}
...
```{r ten_rep_7 budget proportion plot, echo=FALSE}
